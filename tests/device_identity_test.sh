...
assert_equals "$direct_hostname_calls" "8" "devices module should call shared resolver directly in devices_list (2 passes), devices_kick (offline warning + after kick), devices_wake, devices_block, and the two device-picker keyboard helpers"
