...
assert_equals "$direct_hostname_calls" "6" "devices module should call shared resolver directly in devices_list (2 passes), devices_kick (offline warning + after kick), devices_wake, and devices_block"
